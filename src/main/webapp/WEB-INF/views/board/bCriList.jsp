...
<head>
	...
	//	  - 늘 사용해야되는 jQuerry 대신 $ 기호를 사용
	//	    $('#searchBtn').click(funtion(){......
	// => ready 이벤트 
	//		- script 구문이 body 보다 위쪽에 위치하면 Tag 인식이 불가능함 
	//		- Body 가 Tag들을 모두 load 한 후 실행 되도록 이벤트를 저굥ㅇ
	//		- js : window.onload
	...
	<c:choose>
		<c:when test="${pageMaker.prev && pageMaker.spageNo>1}">
			...
			<!-- OLD Version 
			 ...
			 <a href="bcrilist?currPage=${pageMaker.spageNo-1}&rowsPerPage=5">&lt;</a>&nbsp;&nbsp
			-->
